...
variable "cluster_size" {
  description = "Number of nodes to have in the Vault cluster. (3 or 5, default: 3)"
  default     = 3
}
...
variable "bucket_force_destroy" {
  description = "Terraform will delete the Google Cloud Storage Bucket if it is non-empty (default: false)"
  default     = false
}
